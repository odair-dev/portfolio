...
export default function Projects(){
    ...
    function goAPI(){
        window.open("https://db-desa-app.onrender.com/api/docs/", "_blank");
    }
    function goNukenzie(){
        ...
        <div className={styles.container} id='projects'>
            ...
            <div className={styles.subContainer}>
                <div className={styles.gallery} data-aos="fade-right" data-aos-duration="1500">
                    <Image src={DeSa} onClick={()=>goAPI()}  alt="API de Sá"  className={slide==1 ? styles.item_1 : slide==2 ? styles.item_2 : slide==3 ? styles.item_3 : styles.none}/>
                    <div className={styles.divLinks}>
                        <a target='_blank' href={slide==1 ? "https://github.com/odair-dev/burguer" : slide==2 ? "https://github.com/odair-dev/desa-api" : slide==3 ? "https://github.com/odair-dev/nukenzie" : styles.none}>Github</a>
                        <a target='_blank' href={slide==1 ? "https://burguer-five.vercel.app/" : slide==2 ? "https://db-desa-app.onrender.com/api/docs/" : slide==3 ? "https://react-entrega-s1-template-nu-kenzie-odair-dev.vercel.app/" : styles.none}>Deploy</a>
                    </div>
