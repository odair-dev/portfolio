      ...
      <div className={styles.maxSize}>
        ...
        <div className={modalMobile ? styles.divModal : styles.modalNone}>
          <ul>
            <li>
              <a
                href="https://drive.google.com/file/d/1ZH-gChaw9LKuHinfalbJCYOP7iBH8OMZ/view?usp=sharing"
                target="blank"
              >
                Currículo
              </a>
            ...
            <li>
              <a href="https://github.com/odair-dev" target="blank">
                Github
              </a>
            </li>
            <li>
              <a
                href="https://www.linkedin.com/in/odair-sobrinho/"
                target="blank"
              >
                Linkedin
              </a>
